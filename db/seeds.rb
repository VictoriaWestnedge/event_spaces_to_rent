...
#   Character.create(name: "Luke", movie: movies.first)
  ...
  event_space_1 = EventSpace.create!(name:"events room traji", adress:"santiago de chile", description:"beautiful room for wedding", price_per_hour:5, min_hour:3, user:user_1)
  event_space_2 = EventSpace.create!(name:"events room numar", adress:"rubie des", description:"house", price_per_hour:7, min_hour:4, user:user_2)
